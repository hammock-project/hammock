...
public class SwaggerUITest {
    ...
    @Test
    public void testUIRedirect() throws InterruptedException {
        given()
    ...
    @Test
    public void testUILoaded() throws InterruptedException {
        XmlPath body = get(uri + "/openapi.ui").htmlPath();
        assertEquals("Swagger UI", body.get("html.head.title"));
    }
}
