...
m2 = xml.dom.minidom.parse('target/settings.xml')
...
userNode = m2.createTextNode(os.environ["SONAUN"])
passNode = m2.createTextNode(os.environ["STPASS"])
