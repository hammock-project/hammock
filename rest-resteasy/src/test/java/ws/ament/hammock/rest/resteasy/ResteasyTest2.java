...
public class ResteasyTest2 {
    @Deployment
    public static JavaArchive createArchive() {
        return new HammockArchive().classes(RestController2.class, RestApp2.class).jar();
    }
    ...
    public void shouldBeAbleToRetrieveRestEndpoint() throws Exception {
        get(uri + "/path2").then().assertThat().statusCode(200)
                .body(is("Hello, World2!"));
    }
}
